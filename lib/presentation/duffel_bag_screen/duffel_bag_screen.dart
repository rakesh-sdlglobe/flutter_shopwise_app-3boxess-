...
class DuffelBagScreen extends GetWidget<DuffelBagController> {
  const DuffelBagScreen({Key? key}) : super(key: key);
        ...
        child: ColorfulSafeArea(
            ...
            child: Scaffold(
                ...
                appBar: CustomAppBar(
                    ...
                    centerTitle: true,
                    title: AppbarTitle(text: "Duffle bag".tr),
                    actions: [
                     AppbarImage(
                         height: getSize(24),
                         width: getSize(24),
                ...
                body: GetBuilder<DuffelBagController>(
                    init: DuffelBagController(),
                     ...
                     child: Container(
                      ...
                      child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            DuffelBagItemModel model = controller.sweetData[index];
